...
- **It is strongly recommended to clone this and run this locally for better performance as even tho this is hosted on vercel the performance degrades massively doing that**
